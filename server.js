...
async function startFocusSession() {
    ...
    try {
        ...
        // Set the exact time when the timer should finish
...
async function completeFocusSession() {
    ...
    try {
        ...
        // Reload history after completing the session
...
function resetTimer() {
    ...
    // Do not reset an active session
    ...
    try {
        ...
        if (!response.ok) {
            ...
            focusHistory.innerHTML =
                "<p>Could not load focus sessions.</p>";
        ...
        // }
        //
        // Therefore we get the array
        // from data.focus_sessions.
